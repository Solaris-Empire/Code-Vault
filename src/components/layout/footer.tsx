        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold text-gray-900 tracking-tight">CodeVault</span>
            </div>
          ...
          <div>
            <h4 className="font-semibold text-gray-900 mb-4 text-sm">Marketplace</h4>
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link href="/products?featured=true" className="hover:text-green-600 transition-colors">Featured Items</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-semibold text-gray-900 mb-4 text-sm">Sellers</h4>
            <ul className="space-y-2.5 text-sm">
