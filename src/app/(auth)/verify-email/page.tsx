      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-teal-50 px-4">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-none shadow-xl p-8 text-center">
            ...
            <p className="text-(--color-text-muted)">Please wait while we verify your email address.</p>
          </div>
        </div>
      </div>
    )
        ...
        <div className="max-w-md w-full">
          <div className="bg-white rounded-none shadow-xl p-8 text-center">
            ...
            <div className="space-y-3">
              ...
              <Link
                href="/register"
                className="inline-flex items-center justify-center w-full bg-gray-100 text-gray-700 py-3 px-4 rounded-none font-medium hover:bg-gray-200 transition-colors"
              >
                Create new account
              </Link>
            </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-teal-50 px-4">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-none shadow-xl p-8 text-center">
          ...
          {resendSuccess && (
            <div className="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-none text-emerald-700 text-sm">
          ...
          {/* Instructions */}
          <div className="bg-gray-50 rounded-none p-4 mb-6 text-left">
            <h3 className="font-medium text-gray-900 mb-2">Next steps:</h3>
            <ol className="text-sm text-(--color-text-muted) space-y-2">
