...
export const metadata: Metadata = {
  ...
  description: 'Discover thousands of premium scripts, templates, themes, and plugins on CodeVault.',
}
...
function getSortConfig(sort: SortValue): { column: string; ascending: boolean } {
  switch (sort) {
    ...
    case 'popular': return { column: 'download_count', ascending: false }
...
export default async function ProductsPage({
  ...
  searchParams: Promise<{ search?: string; category?: string; sort?: string; featured?: string }>
}) {
